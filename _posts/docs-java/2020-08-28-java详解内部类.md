---
title: java提高篇(八)----详解内部类
permalink: /java/InnerClass/01
tags: java基础
key: java-InnerClass-2020-08-28-01
---
...
## 一、为什么要使用内部类
   ...
   在我们程序设计中有时候会存在一些使用接口很难解决的问题，这个时候我们可以利用内部类提供的、可以继承多个具体的或者抽象的类的能力来解决这些程序设计问题。可以这样说，接口只是解决了部分问题，而 __内部类使得多重继承的解决方案变得更加完整。__
