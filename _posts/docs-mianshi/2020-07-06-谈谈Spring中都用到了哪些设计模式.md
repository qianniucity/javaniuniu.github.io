---
title: 谈谈Spring中都用到了哪些设计模式？
permalink: /mianshi/spring/0706/03
tags: 面试题
key: mianshi-2020-07-06-03
---
...
![img](/assets/images/mianshiti/0706/Jietu20200706-125354@2x.jpg)
...
- `ApplicationContext` ：容器启动的时候，不管你用没用到，一次性创建所有 bean 。`BeanFactory` 仅提供了最基本的依赖注入支持，`ApplicationContext` 扩展了 `BeanFactory` ,除了有`BeanFactory`的功能之外还有额外更多功能，所以一般开发人员使用`ApplicationContext`会更多。
...
Spring通过`ConcurrentHashMap`实现单例注册表的特殊方式实现单例模式。Spring实现单例的核心代码如下：
...
![img](/assets/images/mianshiti/0706/Jietu20200706-125429@2x.jpg)
...
![img](/assets/images/mianshiti/0706/Jietu20200706-125421@2x.jpg)
...
Spring 中 `jdbcTemplate`、`hibernateTemplate` 等**以 Template 结尾的对数据库操作的类**，它们就使用到了模板模式。一般情况下，我们都是使用继承的方式来实现模板模式，但是 Spring 并没有使用这种方式，而是**使用Callback 模式与模板方法模式配合**，既达到了代码复用的效果，同时增加了灵活性。
...
![img](/assets/images/mianshiti/0706/Jietu20200706-125445@2x.jpg)
...
![img](/assets/images/mianshiti/0706/Jietu20200706-125402@2x.jpg)
