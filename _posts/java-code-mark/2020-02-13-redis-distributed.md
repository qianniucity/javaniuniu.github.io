---
title: 基于redis的分布式锁
permalink: /goodjavacode/redis/distributed
...
可参考文档
- [使用Redis实现分布式lock](https://blog.csdn.net/syilt/article/details/100039332)
- [redis系列：基于redis的分布式锁](https://www.cnblogs.com/fixzd/p/9479970.html)
