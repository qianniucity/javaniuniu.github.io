...
|序号| 题目 | 涉及算法及思路 |  难度 |
| :-----| :-----|:-----|:-----|
|057| [560. 和为K的子数组](/leetcode/2020/0515/006) | `前缀和`{:.info} |  `中等`{:.warning}  |
|057| [6. Z 字形变换](/leetcode/2020/0514/006) | `链表`{:.info} |  `中等`{:.warning}  |
|056| [2. 两数相加](/leetcode/2020/0513/005) | `链表`{:.info} |  `中等`{:.warning}  |
|055| [102. 二叉树的层序遍历](/leetcode/2020/0513/006) | `BFS`{:.info}  `DFS`{:.info} |  `中等`{:.warning}  |
|054| [1. 两数之和](/leetcode/2020/0511/005) | `前缀和`{:.info} `哈希表`{:.info}|  `简单`{:.success}  |
|053| [1248. 统计「优美子数组」](/leetcode/2020/0511/006) | `滑动窗口`{:.info}  `按位与运算`{:.info} |  `中等`{:.warning}  |
|052| [50. Pow(x, n)](/leetcode/2020/0511/007) | `折半计算`{:.info}  `递归`{:.info} |  `中等`{:.warning}  |
|051| [199. 二叉树的右视图](/leetcode/2020/0510/007) | `DFS`{:.info}  `BFS`{:.info} |  `中等`{:.warning}  |
|050| [23. 合并K个排序链表](/leetcode/2020/0509/006) | `优先队列`{:.info} |  `困难`{:.error}  |  
|049| [213. 打家劫舍 II](/leetcode/2020/0509/007) | `动态规划`{:.info}  |  `中等`{:.warning}  |
|048| [面试题68 - I. 二叉搜索树的最近公共祖先](/leetcode/2020/0508/008) | `迭代`{:.info} `二叉树`{:.info}|  `简单`{:.success}  |
|047| [508. 出现次数最多的子树元素和](/leetcode/2020/0508/009) | `哈希表`{:.info}  `递归`{:.info} |  `中等`{:.warning}  |
|046| [572. 另一个树的子树](/leetcode/2020/0508/010) | `递归`{:.info} |  `简单`{:.success}  |
|045| [100. 相同的树](/leetcode/2020/0508/011) | `递归`{:.info} |  `简单`{:.success}  |
...
|030| [136. 只出现一次的数字](/leetcode/2020/0428/028/03) | `异或运算`{:.info} `数组`{:.info} |  `简单`{:.success}   |   
...
|014| [121. 买卖股票的最佳时机](/leetcode/2020/0412/015) |  `动态规划`{:.info} `暴力`{:.info}   |  `简单`{:.success}     |     
|013| [面试题29. 顺时针打印矩阵](/leetcode/2020/0411/014) |  `暴力`{:.info}  | `简单`{:.success}    |     
|012| [198. 打家劫舍](/leetcode/2020/0402/013) | `动态规划`{:.info}   | `简单`{:.success}    |     
