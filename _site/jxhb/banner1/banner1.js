...
// 50x50
    (function ($) {
        $.fn.VMiddleImg = function (options) {
            var defaults = {"width": null, "height": null};
...
function dysearch() {
    ...
    document.writeln("<a id=s1>矢量<\/a>");
    document.writeln("<a id=s2>代码<\/a>");
    document.writeln("<a id=s3>图标<\/a>");
    document.writeln("<a id=s4>表情<\/a>");
    document.writeln("<a id=s5>全站<\/a>");
    ...
    document.writeln("<input class=sc name=Input type=\"submit\" value=\"\">");
    ...
    (function () {
        ...
        function selSubSearch(iType) {
            hbb = [];
            hbb = {1: ["矢量", "1"], 2: ["代码", "js"], 3: ["图标", "png"], 4: ["表情", "48"], 5: ["全站", "0"]};
...
function bottomForm() {
    ...
    switch (all_var) {
        case"png":
            document.formsearch.action = 'http://www.lanrentuku.com/manager/plus/png.php?type=search&q=' + q
            break;
        case"js":
            document.formsearch.action = 'http://www.lanrentuku.com/manager/plus/js.php?q=' + q
            break;
        default:
            var Sys = {};
            ...
            document.formsearch.action = 'http://www.lanrentuku.com/plus/search.php?x=' + all_var + '&q=' + q;
            break;
    }
...
var cookie_fs = $.cookie("fs");
var cookie_bg = $.cookie("bg");
$(function () {
    if (cookie_bg) {
        $('#yuedu').css('background', cookie_bg);
    }
    if (cookie_fs) {
        $('#yuedu').css('font-size', cookie_fs + 'px');
    }
});
...
function fontsize(num) {
    switch (num) {
        case 1:
            $("#yuedu").css('font-size', '16px');
            $.cookie("fs", "16", options);
            break;
        case 2:
            $("#yuedu").css('font-size', '14px');
            $.cookie("fs", "14", options);
            break;
        case 3:
            $("#yuedu").css('font-size', '12px');
            $.cookie("fs", "12", options);
            break;
    }
}
...
function backcolor(num) {
    if (num == 1) {
        $("#yuedu").css('background', '#F0F6FC');
        $.cookie("bg", "#F0F6FC", options);
    }
    if (num == 2) {
        $("#yuedu").css('background', '#FFFFFF');
        $.cookie("bg", "#FFFFFF", options);
    }
    if (num == 3) {
        $("#yuedu").css('background', '#F6F6F6');
        $.cookie("bg", "#F6F6F6", options);
    }
}

// bg+gif
$(document).ready(function () {
    $('.content-bg li,.content-gif li').hover(function () {
        $(".save", this).stop().animate({top: '162px'}, {queue: false, duration: 162});
    }, function () {
        $(".save", this).stop().animate({top: '192px'}, {queue: false, duration: 162});
    });
});
